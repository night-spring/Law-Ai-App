...
    { name: 'Bare Acts', icon: 'book', description: 'Access the full text of legal bare acts.' , screen: 'BareActs' },
    { name: 'Database', icon: 'database', description: 'Explore a collection of legal documents and case law.' , screen: 'Database' },
    { name: 'FIR Builder', icon: 'file-text', description: 'Generate and download FIR documents.' , screen: 'FIRDownload' },
